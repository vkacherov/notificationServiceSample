...
import static com.microsoft.web.rest.TestUtil.createFormattingConversionService;
...
public class NotificationResourceIntTest {
    ...
    private static final Channel UPDATED_CHANNEL = Channel.SMS;
    ...
    private static final String DEFAULT_MSG_URI = "AAAAAAAAAA";
    private static final String UPDATED_MSG_URI = "BBBBBBBBBB";
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getMsgUri()).isEqualTo(DEFAULT_MSG_URI);
    }
    ...
    @Test
    @Transactional
    public void checkMsgUriIsRequired() throws Exception {
        int databaseSizeBeforeTest = notificationRepository.findAll().size();
        // set the field null
        notification.setMsgUri(null);
    ...
    public void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].msgUri").value(hasItem(DEFAULT_MSG_URI.toString())));
    }
    ...
    public void getNotification() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications/{id}", notification.getId()))
            ...
            .andExpect(jsonPath("$.msgUri").value(DEFAULT_MSG_URI.toString()));
    }
    ...
    public void updateNotification() throws Exception {
        ...
        assertThat(testNotification.getMsgUri()).isEqualTo(UPDATED_MSG_URI);
    }
